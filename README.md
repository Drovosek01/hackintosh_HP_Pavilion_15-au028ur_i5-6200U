...
MacOSX может быть установлена на диск только с разметкой GPT (GUID Partition Table).
...
* Если ваш диск размечен в GPT, то можно в Windows отделить разедл и потом на него установить MacOSX
